...
export const ASSIGNED_USER_TO_ISSUE_REQUEST = "ASSIGNED_USER_TO_ISSUE_REQUEST";
export const ASSIGNED_USER_TO_ISSUE_SUCCESS = "ASSIGNED_USER_TO_ISSUE_SUCCESS";
export const ASSIGNED_USER_TO_ISSUE_FAILURE = "ASSIGNED_USER_TO_ISSUE_FAILURE";
